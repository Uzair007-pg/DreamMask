...
class COCOInstanceNewBaselineDatasetMapper:
    ...
    def __call__(self, dataset_dict):
        ...
        # DreamMask / NSS: mark whether this sample is synthetic.
        # - If caller sets dataset_dict["is_synthetic"] (e.g. synthetic dataset), keep it.
        # - Otherwise default to False for real images.
        ...
        if "annotations" in dataset_dict:
            ...
            # tightly bound the object. So we recompute from masks.
